      ...
      <nav className='navbar-unique'>
        ...
        <div className='navbar-menu-container'>
          <ul className={`navbar-menu ${menuOpen ? 'active' : ''}`}>
            <li><a onClick={() => handleScrollToSection('home')} href='#home'>Home</a></li>
            <li><a onClick={() => handleScrollToSection('about')} href='#about'>About Us</a></li>
            <li><a onClick={() => handleScrollToSection('services')} href='#services'>Services</a></li>
            <li><a onClick={() => handleScrollToSection('contact')} href='#contact'>Contact</a></li>
          </ul>
        </div>
